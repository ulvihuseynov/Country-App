...
function Card({name, flags,capital,region}) {
  return (
    <div>
     <div className="max-w-xs p-2 rounded-md shadow-md dark:bg-gray-50 dark:text-gray-900">
	<img src={flags?.png} alt="" className="  w-full rounded-md h-72 dark:bg-gray-500" />
